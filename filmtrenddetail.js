...
module.exports = bot => {
    ...
    if(isNaN(arg)) {
        return bot.sendMessage(msg.chat.id, 'ERROR | Masukkan angka filmdetail 1-20 ngab...')
    }
...
await bot.sendPhoto(msg.chat.id, `https://image.tmdb.org/t/p/w500` + res.data.results[arg - 1].poster_path)
