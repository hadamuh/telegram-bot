...
if(msg.from.username != undefined) {
  console.log(`[${dateInNewTimezone}] - [${msg.from.username} | ${msg.from.id}] > ${msg.text}\n`)
} else if(msg.from.username === undefined) {
  console.log(`[${dateInNewTimezone}] - [${msg.from.first_name} ${msg.from.last_name} | ${msg.from.id}] > ${msg.text}\n`)
}
